...
-(void)showLeftView{
    ...
    mainControl.view.center = CGPointMake([UIScreen mainScreen].bounds.size.width+20,[UIScreen mainScreen].bounds.size.height/2);
    [UIView commitAnimations];
...
-(void)showRighView{
    [UIView beginAnimations:nil context:nil];
    mainControl.view.transform = CGAffineTransformScale(CGAffineTransformIdentity,0.8,0.8);
    mainControl.view.center = CGPointMake(-20,[UIScreen mainScreen].bounds.size.height/2);
    [UIView commitAnimations];
}
